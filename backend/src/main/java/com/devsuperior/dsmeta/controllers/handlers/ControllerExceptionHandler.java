...
import com.devsuperior.dsmeta.services.exceptions.ForbiddenException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> resourceNotFound(ResourceNotFoundExceotion e, HttpServletRequest request) {
